...
kubectl delete pod quota-pod -n limited-ns --ignore-not-found=true 2>/dev/null
kubectl delete resourcequota compute-quota -n limited-ns --ignore-not-found=true 2>/dev/null
kubectl delete limitrange resource-limits -n limited-ns --ignore-not-found=true 2>/dev/null
force_delete_namespace "limited-ns"
