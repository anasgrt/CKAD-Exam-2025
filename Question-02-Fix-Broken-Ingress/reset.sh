...
kubectl delete ingress web-ingress -n production --ignore-not-found=true 2>/dev/null
kubectl delete svc web-service -n production --ignore-not-found=true 2>/dev/null
kubectl delete deployment web-app -n production --ignore-not-found=true 2>/dev/null
