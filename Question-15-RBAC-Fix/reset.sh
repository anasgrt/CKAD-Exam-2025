...
# Delete all roles and rolebindings
kubectl delete rolebinding scraper-binding log-binding -n rbac-ns --ignore-not-found=true 2>/dev/null || true
kubectl delete role pod-list-role log-read-role -n rbac-ns --ignore-not-found=true 2>/dev/null || true

# Delete namespace
force_delete_namespace "rbac-ns"
