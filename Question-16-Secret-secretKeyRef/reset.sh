...
kubectl delete deployment db-app -n secret-ns --ignore-not-found=true 2>/dev/null
kubectl delete secret db-secret -n secret-ns --ignore-not-found=true 2>/dev/null
force_delete_namespace "secret-ns"
