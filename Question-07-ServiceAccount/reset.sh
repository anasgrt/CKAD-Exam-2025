...
kubectl delete deployment secure-app -n secure-ns --ignore-not-found=true 2>/dev/null
kubectl delete rolebinding pod-reader-binding -n secure-ns --ignore-not-found=true 2>/dev/null
kubectl delete role pod-reader-role -n secure-ns --ignore-not-found=true 2>/dev/null
kubectl delete serviceaccount pod-reader-sa -n secure-ns --ignore-not-found=true 2>/dev/null
force_delete_namespace "secure-ns"
