...
kubectl delete deployment backend-deployment -n staging --ignore-not-found=true 2>/dev/null
kubectl delete secret db-credentials db-credentials-old -n staging --ignore-not-found=true 2>/dev/null
