...
kubectl delete ingress ingress-name -n external --ignore-not-found=true 2>/dev/null
kubectl delete svc webapp -n external --ignore-not-found=true 2>/dev/null
kubectl delete deployment webapp -n external --ignore-not-found=true 2>/dev/null
force_delete_namespace "external"
