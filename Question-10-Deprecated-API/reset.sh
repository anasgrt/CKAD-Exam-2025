...
kubectl delete deployment legacy-app -n migration-ns --ignore-not-found=true 2>/dev/null
force_delete_namespace "migration-ns"
rm -f /tmp/legacy-deployment.yaml
