...
kubectl delete svc frontend-service -n web-ns --ignore-not-found=true 2>/dev/null
kubectl delete deployment frontend-app -n web-ns --ignore-not-found=true 2>/dev/null
force_delete_namespace "web-ns"
