...
kubectl delete deployment web-app web-app-canary -n canary-ns --ignore-not-found=true 2>/dev/null
kubectl delete svc web-service -n canary-ns --ignore-not-found=true 2>/dev/null
force_delete_namespace "canary-ns"
