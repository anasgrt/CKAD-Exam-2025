...
kubectl delete deployment frontend-app -n svc-ns --ignore-not-found=true 2>/dev/null
kubectl delete service frontend-svc -n svc-ns --ignore-not-found=true 2>/dev/null
force_delete_namespace "svc-ns"
